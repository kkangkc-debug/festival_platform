...
define('G5_PARTNER_URL',    G5_URL.'/'.G5_PARTNER_DIR);
...
define('G5_OKNAME_PATH',    G5_PLUGIN_PATH.'/'.G5_OKNAME_DIR);  // <-- DIR 로 수정완료
define('G5_PARTNER_PATH',   G5_PATH.'/'.G5_PARTNER_DIR);
