...
$menu["menu800"] = array(
    ...
    array('800600', '음식점 관리', G5_ADMIN_URL . '/restaurant_list.php', 'restaurant_list'),
    ...
    // [수정됨] 앞 3자리를 무조건 800으로 맞춤
    array('800910', '결제 관리', G5_ADMIN_URL . '/payment_list.php', 'payment_list'),
    array('800920', '시스템 관리(로그)', G5_ADMIN_URL . '/admin_log_list.php', 'system_config') 
);
?>